STRINGS: dict[str, str] = {
    ...
    "err_foreign_job": "Эта карточка принадлежит другому пользователю. Пришлите свою ссылку.",
    "err_no_ffmpeg": (
        "На сервере не установлен ffmpeg — mp3 недоступен.\n"
        "Попросите администратора установить ffmpeg или выберите видео."
    ),
    "err_merge": (
        "Не удалось соединить видео со звуком (сбой ffmpeg).\nПопробуйте другое качество."
    ),
